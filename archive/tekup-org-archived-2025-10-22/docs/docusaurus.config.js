...
const config = {
  ...
  tagline: 'Multi-tenant Incident Response Ecosystem',
  ...
  organizationName: 'TekUp-org', // Usually your GitHub org/user name.
  projectName: 'tekup-org', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/TekUp-org/tekup-org/tree/main/docs/',
        },
        blog: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Flow API',
                to: '/docs/apps/flow-api',
              },
              {
                label: 'Flow Web',
                to: '/docs/apps/flow-web',
              },
              {
                label: 'TekUp CRM',
                to: '/docs/apps/crm',
