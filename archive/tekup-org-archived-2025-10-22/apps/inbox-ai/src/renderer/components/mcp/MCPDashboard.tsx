...
export const MCPDashboard: React.FC<MCPDashboardProps> = ({ className }) => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case 'plugins':
        return <div className="p-4">Plugin Manager placeholder - will be implemented soon</div>;
      case 'tools':
        return <div className="p-4">Tool Executor placeholder - will be implemented soon</div>;
      case 'resources':
