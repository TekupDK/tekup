import { X, RotateCcw, Plus, Edit3, Trash2, RefreshCcw } from "lucide-react";
...
export function SettingsModal({ isOpen, onClose }: SettingsModalProps) {
  ...
  const { config, resetConfig, addAgent, updateAgent, removeAgent, isInitialized, syncFromBackend, isSyncing } = useAgentConfig();
        ...
        <div style={{ marginBottom: "24px" }}>
          ...
          >
            ...
            <div style={{ display: "flex", gap: 8 }}>
              ...
              <button
                onClick={async () => { try { await syncFromBackend(); } catch {} }}
                disabled={isSyncing}
                style={{
                  padding: "6px 12px",
                  borderRadius: "6px",
