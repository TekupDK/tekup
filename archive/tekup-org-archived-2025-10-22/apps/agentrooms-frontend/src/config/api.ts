...
export const API_CONFIG = {
  ENDPOINTS: {
    ...
    // New: backend agents list for sync
    AGENTS: "/api/agents",
  },
} as const;
...
// New: helper to get agents list URL from backend (for sync/auto-seed)
export const getAgentsUrl = (orchestratorEndpoint?: string) => {
  return getApiUrl(API_CONFIG.ENDPOINTS.AGENTS, orchestratorEndpoint);
};
