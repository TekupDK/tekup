...
try {
  ...
  logger.info("✅ Auth files copied to dist directory");
} catch (error) {
  logger.warn("⚠️ Failed to copy auth files:", error.message);
}

logger.info("✅ CLI bundle created successfully");
logger.info("✅ Lambda bundle created successfully");
