...
const Navigation = () => {
  ...
  const navigation = [
    ...
    { name: 'Lager', href: '/inventory', icon: '📦' },
    { name: 'Medarbejdere', href: '/staff', icon: '👥' },
    { name: 'Rapporter', href: '/reports', icon: '📈' },
    { name: 'Indstillinger', href: '/settings', icon: '⚙️' },
  ]
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <div className="flex-shrink-0 flex items-center">
              <h1 className="text-2xl font-bold text-blue-600">🏪 RestaurantIQ</h1>
            </div>
          </div>
