export const FOODTRUCK_VOICE_WORKFLOWS = [
    {
        id: 'foodtruck_order',
...
export const PERFUME_VOICE_WORKFLOWS = [
    {
...
export const CONSTRUCTION_VOICE_WORKFLOWS = [
    {
...
export const getWorkflowsByBusiness = (businessType) => {
    switch (businessType) {
        case 'foodtruck':
...
export const getWorkflowsByPhrase = (phrase) => {
    ...
    return allWorkflows.filter(workflow => workflow.danishPhrases.some(danishPhrase => danishPhrase.toLowerCase().includes(lowerPhrase)));
};
//# sourceMappingURL=business-voice-workflows.js.map