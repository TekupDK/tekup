...
exports.getAllCommands = exports.searchCommands = exports.getCommandsByFunction = exports.getCommandsByCategory = exports.DANISH_VOICE_COMMANDS = void 0;
exports.DANISH_VOICE_COMMANDS = [
    // LEAD MANAGEMENT
    {
        id: 'show_all_leads',
...
const getCommandsByCategory = (category) => {
    return exports.DANISH_VOICE_COMMANDS.filter(cmd => cmd.category === category);
};
exports.getCommandsByCategory = getCommandsByCategory;
const getCommandsByFunction = (functionId) => {
    return exports.DANISH_VOICE_COMMANDS.filter(cmd => cmd.functionId === functionId);
};
exports.getCommandsByFunction = getCommandsByFunction;
const searchCommands = (query) => {
    const lowerQuery = query.toLowerCase();
    return exports.DANISH_VOICE_COMMANDS.filter(cmd => cmd.danishPhrase.toLowerCase().includes(lowerQuery) ||
...
const getAllCommands = () => {
    return exports.DANISH_VOICE_COMMANDS;
};
exports.getAllCommands = getAllCommands;
//# sourceMappingURL=danish-commands.js.map