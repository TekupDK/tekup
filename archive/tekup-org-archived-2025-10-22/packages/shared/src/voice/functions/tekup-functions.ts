...
export const TEKUP_FUNCTIONS: VoiceCommand[] = [
  {
    id: 'get_leads',
    name: 'get_leads',
...
export const getFunctionById = (id: string): VoiceCommand | undefined => {
  return TEKUP_FUNCTIONS.find(func => func.id === id);
};

export const getFunctionsByTenant = (tenant: string): VoiceCommand[] => {
  return TEKUP_FUNCTIONS.filter(func => func.tenant_required);
};

export const getAllFunctions = (): VoiceCommand[] => {
  return TEKUP_FUNCTIONS;
};