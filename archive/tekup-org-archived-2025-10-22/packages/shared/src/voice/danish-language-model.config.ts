...
export const DANISH_BUSINESS_VOCABULARY: DanishBusinessVocabulary = {
  foodtruck: {
    menu: [
...
export const DANISH_REGIONAL_ACCENTS: DanishRegionalAccent[] = [
  {
    region: 'copenhagen',
    phoneticPatterns: [
...
export const getDanishLanguageConfig = (
  businessType: 'foodtruck' | 'perfume' | 'construction' | 'unified',
...
const getOfflineCommands = (businessType: string): string[] => {
