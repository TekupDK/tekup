...
export type MCPEventType = 'server_connected' | 'server_disconnected' | 'server_error' | 'tool_called' | 'tool_completed' | 'resource_accessed' | 'prompt_requested' | 'plugin_installed' | 'plugin_uninstalled' | 'plugin_enabled' | 'plugin_disabled' | 'plugin_updated';
