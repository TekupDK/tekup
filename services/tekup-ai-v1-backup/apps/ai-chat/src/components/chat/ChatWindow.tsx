...
export function ChatWindow({ sessionId, initialMessages = [], messages: externalMessages, isLoading: externalLoading }: ChatWindowProps) {
  const [messages, setMessages] = useState<Message[]>(externalMessages || initialMessages.map(m => ({
    id: m.id,
    role: m.role,
    content: m.content,
