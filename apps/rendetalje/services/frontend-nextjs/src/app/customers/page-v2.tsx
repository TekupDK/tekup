...
export default function CustomersPage() {
  ...
  const { customers, isLoading, error, searchQuery, setSearchQuery, fetchCustomers, createCustomer, deleteCustomer } = useCustomersStore();
                      ...
                      <div className="flex items-start text-gray-600">
                        ...
                        <div>
                          ...
                          {customer.address.postal_code && customer.address.city && (
                            <p>{customer.address.postal_code} {customer.address.city}</p>
                          )}
                        </div>
                      </div>
                    )}
