  ...
  fetchJobs: async () => {
    ...
    try {
      ...
      set({
        isLoading: false,
        error:
          error instanceof Error ? error.message : "Fejl ved hentning af jobs",
      });
    }
  },
  ...
  fetchJobById: async (id: string) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        error:
          error instanceof Error ? error.message : "Fejl ved hentning af job",
      });
    }
  },
  ...
  createJob: async (job) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        error:
          error instanceof Error ? error.message : "Fejl ved oprettelse af job",
      });
      throw error;
    }
  },
  ...
  updateJob: async (id, updates) => {
    ...
    try {
      ...
      set((state) => ({
        ...
        selectedJob:
          state.selectedJob?.id === id ? data.job : state.selectedJob,
        isLoading: false,
      }));
    } catch (error) {
      set({
        isLoading: false,
        error:
          error instanceof Error ? error.message : "Fejl ved opdatering af job",
      });
      throw error;
    }
  },
  ...
  deleteJob: async (id) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        error:
          error instanceof Error ? error.message : "Fejl ved sletning af job",
      });
      throw error;
    }
  },
