...
export const useCustomersStore = create<CustomersState>((set, get) => ({
  ...
  fetchCustomers: async () => {
    ...
    try {
      ...
      set({
        isLoading: false,
        error: error instanceof Error ? error.message : 'Fejl ved hentning af kunder',
      });
    }
  },
  ...
  fetchCustomerById: async (id: string) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        error: error instanceof Error ? error.message : 'Fejl ved hentning af kunde',
      });
    }
  },
  ...
  createCustomer: async (customer) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        error: error instanceof Error ? error.message : 'Fejl ved oprettelse af kunde',
      });
      throw error;
    }
  },
  ...
  updateCustomer: async (id, updates) => {
    ...
    try {
      ...
      set((state) => ({
        ...
        selectedCustomer:
          state.selectedCustomer?.id === id ? data.customer : state.selectedCustomer,
        isLoading: false,
      }));
    } catch (error) {
      set({
        isLoading: false,
        error: error instanceof Error ? error.message : 'Fejl ved opdatering af kunde',
      });
      throw error;
    }
  },
  ...
  deleteCustomer: async (id) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        error: error instanceof Error ? error.message : 'Fejl ved sletning af kunde',
      });
      throw error;
    }
  },
