...
test.describe('Customer Management', () => {
  ...
  test('should display customers list page', async ({ page }) => {
    ...
    await expect(page.getByRole('button', { name: /tilføj kunde/i })).toBeVisible();
  });

  test('should open customer creation modal', async ({ page }) => {
    await page.getByRole('button', { name: /tilføj kunde/i }).click();
    
    await expect(page.getByRole('dialog', { name: /tilføj kunde/i })).toBeVisible();
  ...
  test('should view customer details', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: /kunde detaljer/i })).toBeVisible();
  ...
  test('should view customer job history', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: /job historik/i })).toBeVisible();
  ...
  test('should delete customer with confirmation', async ({ page }) => {
    ...
    await expect(page.getByRole('dialog', { name: /bekræft sletning/i })).toBeVisible();
