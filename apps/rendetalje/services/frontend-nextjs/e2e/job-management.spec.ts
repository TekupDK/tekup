...
test.describe('Job Management', () => {
  ...
  test('should display jobs list page', async ({ page }) => {
    ...
    await expect(page.getByRole('button', { name: /opret job/i })).toBeVisible();
  });

  test('should open job creation modal', async ({ page }) => {
    await page.getByRole('button', { name: /opret job/i }).click();
    
    await expect(page.getByRole('dialog', { name: /opret job/i })).toBeVisible();
  ...
  test('should view job details', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: /job detaljer/i })).toBeVisible();
