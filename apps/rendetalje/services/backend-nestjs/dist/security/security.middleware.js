...
const createRateLimiters = (configService) => {
    ...
    return {
        general: (0, express_rate_limit_1.rateLimit)({
            windowMs: 15 * 60 * 1000,
        ...
        auth: (0, express_rate_limit_1.rateLimit)({
            windowMs: 15 * 60 * 1000,
        ...
        passwordReset: (0, express_rate_limit_1.rateLimit)({
            windowMs: 60 * 60 * 1000,
        ...
        upload: (0, express_rate_limit_1.rateLimit)({
            windowMs: 15 * 60 * 1000,
