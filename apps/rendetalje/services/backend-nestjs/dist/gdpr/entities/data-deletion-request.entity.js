...
exports.DataDeletionRequest = void 0;
...
__decorate([
    ...
    __metadata("design:type", String)
], DataDeletionRequest.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '2025-01-15T10:00:00Z', description: 'Request date' }),
    __metadata("design:type", Date)
], DataDeletionRequest.prototype, "requestDate", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '2025-02-15T10:00:00Z', description: 'Scheduled deletion date (30-day grace period)' }),
    __metadata("design:type", Date)
], DataDeletionRequest.prototype, "scheduledDeletionDate", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'pending', enum: ['pending', 'processing', 'completed', 'cancelled'], description: 'Request status' }),
    __metadata("design:type", String)
], DataDeletionRequest.prototype, "status", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'User requested account closure', description: 'Reason for deletion' }),
    __metadata("design:type", String)
...
__decorate([
    ...
    __metadata("design:type", Date)
], DataDeletionRequest.prototype, "updatedAt", void 0);
