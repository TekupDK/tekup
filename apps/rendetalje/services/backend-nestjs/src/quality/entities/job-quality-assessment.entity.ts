import { ApiProperty, ApiPropertyOptional } from '../../common/entities/base.entity';
...
export class JobQualityAssessment extends BaseEntity {
  ...
  @ApiPropertyOptional({ example: '00000000-0000-0000-0000-000000000003', description: 'User who performed assessment' })
  assessed_by?: string;
