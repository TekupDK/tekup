# 👑 Owner Portal - Complete User Guide
...
- **Customer Value**: Revenue per customer over time
...
- **Team Performance**: Quality scores per team member
...
1. **Navigate** til Dashboard → Customize
