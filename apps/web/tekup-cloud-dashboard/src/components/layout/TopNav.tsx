...
export function TopNav() {
  ...
  const mockTenants = [
    { id: '1', name: 'Acme Corporation', plan: 'enterprise' as const, logo: '', created_at: '', active: true },
    { id: '2', name: 'TechStart Inc', plan: 'professional' as const, logo: '', created_at: '', active: true },
    { id: '3', name: 'Local Business', plan: 'starter' as const, logo: '', created_at: '', active: true },
  ];
